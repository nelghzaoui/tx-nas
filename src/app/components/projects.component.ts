  ...
  template: `
    <section
      class="flex flex-col text-white gap-10
            md:gap-[3.75rem] md:pt-[1.5rem] md:pr-[1.5rem] md:pb-[6.25rem] md:pl-[1.5rem]
            lg:pt-[8rem] lg:pr-[3rem] lg:pb-[6.25rem] lg:pl-[3rem] lg:max-w-[1062px] lg:mx-auto"
    >
      <div class="flex items-center justify-between">
        <h4 class="text-4xl font-bold leading-[2.5rem] lg:text-7xl">
          Projects
        </h4>
      ...
      <ul
        class="flex flex-col flex-wrap gap-10 md:p-0 md:grid md:grid-cols-2 md:gap-y-[3.75rem] md:gap-x-[1.5rem]"
      >
